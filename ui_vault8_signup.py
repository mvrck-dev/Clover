...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.emailfield.setGeometry(QRect(532, 179, 311, 51))
        ...
        self.pwdfield.setGeometry(QRect(532, 239, 311, 51))
        ...
        self.cnfpwdfield.setGeometry(QRect(532, 300, 311, 51))
        ...
        self.signupbutton.setGeometry(QRect(532, 368, 310, 50))
        font1 = QFont()
        ...
        self.alertbox.setGeometry(QRect(532, 430, 291, 31))
        self.returnbtn = QPushButton(self.SignUpScreen)
        self.returnbtn.setObjectName(u"returnbtn")
        self.returnbtn.setGeometry(QRect(527, 60, 50, 50))
